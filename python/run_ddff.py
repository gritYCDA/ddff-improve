...
if __name__ == "__main__":
    ...
    parser.add_argument('--epochs', default=2, type=int, help='number of training epochs (default: 200)')
    ...
    parser.add_argument('--checkpoint_frequency', default=2, type=int, help='Checkpoint frequency to save intermediate models. (default: 5)')
